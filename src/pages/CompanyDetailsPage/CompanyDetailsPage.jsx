...
function CompanyDetailsPage() {
  ...
  if (isLoading) return <p className="company-details-status">Loading company...</p>
  if (errorMessage) return <p className="company-details-error">{errorMessage}</p>
  if (!company) return <p className="company-details-error">Company not found</p>
